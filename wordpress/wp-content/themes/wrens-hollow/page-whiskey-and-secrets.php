...
$wh_product_id = function_exists( 'wc_get_product_id_by_sku' ) ? wc_get_product_id_by_sku( wh_shop_sku( 'whiskey-and-secrets' ) ) : 0;
...
<section class="sec sec--pink sec--dashed-top">
  <div class="wrap sec--center">
    ...
    <?php get_template_part( 'template-parts/optin-form', null, array( 'book' => 'whiskey-and-secrets' ) ); ?>
  </div>
</section>
