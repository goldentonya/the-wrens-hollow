...
<section class="sec sec--cream2">
  <div class="wrap bio-row">
    <div class="ph-box"><img src="<?php echo esc_url( get_template_directory_uri() . '/images/photos/ali-wren-portrait.jpg' ); ?>" alt="Ali Wren author portrait" style="width:140px;height:160px;object-fit:cover;border-radius:8px;"></div>
    <div>
      <p class="eyebrow">Behind the pen</p>
      <h1 class="h-lg">Hi, I'm Ali Wren</h1>
