		...
		array(
			...
			'fields'   => array(
				...
				array(
					...
					'type'    => 'message',
					'message' => 'The two "Reading order" cards. (Covers and buttons are set automatically from the books.)',
				),
				array(
					'key'           => 'field_wh_vp_r1_tag',
					'label'         => 'Reading order 1 — tag',
					'name'          => 'reading1_tag',
					'type'          => 'text',
					'default_value' => 'Book 1 · First chapters free',
				),
				array(
					'key'           => 'field_wh_vp_r1_title',
					'label'         => 'Reading order 1 — title',
					'name'          => 'reading1_title',
					'type'          => 'text',
					'default_value' => 'Veilfall',
				),
				array(
					'key'           => 'field_wh_vp_r1_blurb',
					'label'         => 'Reading order 1 — blurb',
					'name'          => 'reading1_blurb',
					'type'          => 'textarea',
					'rows'          => 4,
					'default_value' => "She was hidden in the human realm to stay safe. But magic has a way of finding what was never meant to be forgotten. When Veralyn's parents are killed, she learns the truth — she's fae, and bound to a prophecy that could alter the fate of Sylvaeris, forcing her into the dangerous halls of Auravale Academy.",
				),
				array(
					'key'           => 'field_wh_vp_r2_tag',
					'label'         => 'Reading order 2 — tag',
					'name'          => 'reading2_tag',
					'type'          => 'text',
					'default_value' => 'Book 2 · Coming soon',
				),
				array(
					'key'           => 'field_wh_vp_r2_title',
					'label'         => 'Reading order 2 — title',
					'name'          => 'reading2_title',
					'type'          => 'text',
					'default_value' => 'Veilbound',
				),
				array(
					'key'           => 'field_wh_vp_r2_blurb',
					'label'         => 'Reading order 2 — blurb',
					'name'          => 'reading2_blurb',
					'type'          => 'textarea',
					'rows'          => 4,
	...
	acf_add_local_field_group(
		array(
			...
			'fields'   => array(
				...
				array(
					'key'           => 'field_wh_wtf_r1_title',
					'label'         => 'Reading order 1 — title',
					'name'          => 'reading1_title',
					'type'          => 'text',
					'default_value' => 'Whiskey & Secrets',
				),
				array(
					'key'           => 'field_wh_wtf_r1_blurb',
					'label'         => 'Reading order 1 — blurb',
					'name'          => 'reading1_blurb',
					'type'          => 'textarea',
					'rows'          => 4,
					'default_value' => 'When biological anthropology grad student Sarah leads a research expedition into the Amazon, she never expects to need military protection — least of all from Wade "Wraith" Blakely, the stoic former Green Beret assigned to keep her team safe. When one of them goes missing, secrets buried in the jungle, and in Sarah\'s past, start to surface.',
				),
				array(
					'key'           => 'field_wh_wtf_r2_tag',
					'label'         => 'Reading order 2 — tag',
					'name'          => 'reading2_tag',
					'type'          => 'text',
					'default_value' => 'Book 2 · Free',
				),
				array(
					'key'           => 'field_wh_wtf_r2_title',
					'label'         => 'Reading order 2 — title',
					'name'          => 'reading2_title',
					'type'          => 'text',
					'default_value' => 'Whiskey & Lies',
				),
				array(
					'key'           => 'field_wh_wtf_r2_blurb',
					'label'         => 'Reading order 2 — blurb',
					'name'          => 'reading2_blurb',
					'type'          => 'textarea',
					'rows'          => 4,
