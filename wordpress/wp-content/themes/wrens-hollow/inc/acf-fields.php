...
function wrens_hollow_register_acf_fields() {
	...
	// Team roster, Journey timeline, and Facts no longer have ACF field groups
	// here — they're each shown on exactly one page, so they're edited as
	// inline "add row / remove row" lists directly on that page instead (see
	// inc/inline-repeaters.php), rather than through a separate CPT menu.
}
